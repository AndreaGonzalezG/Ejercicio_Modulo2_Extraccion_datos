...
SELECT DISTINCT last_name AS Apellidos
FROM employees
WHERE last_name IN (SELECT contact_last_name FROM customers);


/* 2. Selecciona los nombres con alias 'nombre' y apellidos, con alias 'Apellidos' tanto de los clientes como de los empleados 
...
SELECT customer_name, city
FROM customers 
WHERE city LIKE '_%on';

/* 8. Encuentra el nombre del cliente, primera dirección y ciudad de aquellas ciudades que contengan el número 3 en su 
...
/* 9. Encuentra el nombre del cliente, primera dirección y ciudad de aquellas ciudades que contengan el número 3 en su 
